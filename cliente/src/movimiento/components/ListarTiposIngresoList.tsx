...
return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-6 sm:py-8 px-4 sm:px-6 lg:px-8" style={{ scrollbarGutter: 'stable' }}>
      <div className="max-w-7xl mx-auto">
        {renderTitle ({title: "Tipos de Ingresos", subtitle: "Administra los tipos de ingresos", icon: <FaMoneyBillWave className="text-white text-3xl sm:text-4xl" />})}
        ...
        {!loading && ingresos.length === 0 && (
          <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">
              {search
                ? 'No se encontraron tipos de ingresos con ese criterio de búsqueda'
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
                      ...
                      <div className="flex-1 min-w-0 overflow-hidden">
                        <h3 className="font-bold text-base truncate">{ingreso.descripcion}</h3>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    <CardText
                      ...
                      text={formatDate(ingreso.created_at)}
                    />
                  </div>
