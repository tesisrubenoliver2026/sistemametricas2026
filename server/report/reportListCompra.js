...
import { reportListCompra } from './template/reportListCompra.js';
...
export const generateReportListCompra = async (dataReport) => {
  try {
    ...
    console.error('❌ Error al generar reporte de compras:', err.message);
    return null;
  }
};
