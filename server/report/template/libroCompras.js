export const libroComprasTemplate = `<style>
  @media print {
    @page {
      size: A4 landscape;
      margin: 10mm;
  ...
  <tbody>
    {{#each reporte.compras}}
      <tr>
        ...
        <td class="text-center">{{proveedor_ruc}}</td>
...
<div class="resumen-final">
  <h3>RESUMEN LIBRO DE COMPRAS</h3>
  <div class="resumen-grid">
    ...
    <div class="resumen-item">
      <span>Compras Crédito:</span>
      <strong>{{reporte.estadisticas.compras_credito}}</strong>
    </div>
    <div class="resumen-item">
      <span>Compras Gravadas 10%:</span>
      <strong>{{reporte.totales.gravada_10}} Gs.</strong>
    </div>
    <div class="resumen-item">
      <span>Compras Gravadas 5%:</span>
...
<div style="text-align: center; padding: 50px; font-size: 12px; color: #999;">
  <p>⚠️ No hay compras registradas para el período seleccionado</p>
</div>
{{/if}}

<div class="footer">
  <p>Libro de Compras generado el {{empresa.fecha_emision}}</p>
