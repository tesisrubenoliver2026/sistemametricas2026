...
import { reportListClient } from './template/reportListClient.js';
...
export const generateReportListClient = async (dataFactura) => {
  try {
    ...
    console.error('❌ Error al generar reporte de clientes:', err.message);
    return null;
  }
};
