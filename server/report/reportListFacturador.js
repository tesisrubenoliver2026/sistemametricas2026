...
import { reportListFacturador } from './template/reportListFacturador.js';
import db from '../db.js';

const templates = {
  "t1": reportListFacturador
};
...
export const generateReportListFacturador = async (dataReport) => {
  try {
    ...
    console.error('❌ Error al generar reporte de facturadores:', err.message);
    return null;
  }
};
