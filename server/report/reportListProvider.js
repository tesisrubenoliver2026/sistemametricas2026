...
import { reportListProvider } from './template/reportListProvider.js';
import db from '../db.js';

const templates = {
  "t1": reportListProvider
};
...
export const generateReportListProvider = async (dataReport) => {
  try {
    ...
    console.error('❌ Error al generar reporte de proveedores:', err.message);
    return null;
  }
};
