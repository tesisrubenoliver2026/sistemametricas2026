...
export default function CrearDatosFacturador({ onSuccess, onClose }: CrearDatosFacturadorProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            Alert.alert('Éxito', 'Facturador creado correctamente');
            ...
            console.error(error);
            const errorMessage = error.response?.data?.error || 'No se pudo crear el facturador';
        ...
        <View>
            ...
            <View className="flex-row items-center justify-between mb-6">
                <View className="flex-row items-center gap-3">
                    ...
                    <Text className="text-2xl font-bold text-gray-800">Crear Facturador</Text>
                </View>
                <Pressable
                    onPress={onClose}
