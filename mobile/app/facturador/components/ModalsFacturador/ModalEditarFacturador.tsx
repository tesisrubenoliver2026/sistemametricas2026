// components/modals/ModalEditarFacturador.tsx
...
export default function ModalEditarFacturador({
  id,
  isOpen,
  onClose,
  onSuccess,
}: ModalEditarFacturadorProps) {
  return (
    <Modal
      visible={isOpen}
      transparent
          ...
          >
            <View className="flex-1 px-6 pt-6 pb-4">
              <ScrollView
                ...
                bounces={false}
              >
                <EditarFacturador id={id} onSuccess={onSuccess} onClose={onClose} />
              </ScrollView>
            </View>
          </View>
        </KeyboardAvoidingView>
