// components/modals/ModalsEditarActividadesEconomicas.tsx
...
export default function ModalsEditarActividadesEconomicas({
  id,
  isOpen,
  onClose,
  onSuccess,
}: ModalsEditarActividadesEconomicasProps) {
  return (
    <Modal
      visible={isOpen}
      transparent
