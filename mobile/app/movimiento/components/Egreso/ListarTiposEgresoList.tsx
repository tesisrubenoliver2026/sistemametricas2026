...
const ListarTiposEgresoList = ({ onSelect }: ListarTiposEgresoProps) => {
  ...
  const handleAnular = (id: number, descripcion: string) => {
    Alert.alert(
      'Confirmar anulación',
      `¿Estás seguro de que deseas anular el tipo de egreso "${descripcion}"?`,
      [
        ...
        >
          <View className="flex-row items-center justify-between mb-4">
            <View className="flex-row items-center gap-3">
              ...
              <Text className="text-2xl font-bold text-white">Tipos de Egresos</Text>
            </View>
          </View>
          ...
          <View className="flex-row gap-3">
            ...
            >
              ...
              >
                ...
                <Text className="text-red-700 font-semibold">Crear Nuevo</Text>
              </LinearGradient>
            </Pressable>

            <View className="bg-white/20 rounded-xl p-3 flex-row items-center justify-between flex-1">
              ...
              <View className="flex-row items-center gap-2">
                ...
                />
                <Text className="text-white text-sm">por página</Text>
              </View>
            </View>
          </View>
        </LinearGradient>
        ...
        <View className="px-5 mt-4">
          {loading ? (
            <View className="py-20 items-center justify-center">
              ...
              <Text className="text-gray-500 mt-4">Cargando tipos de egresos...</Text>
            </View>
          ) : egresos.length === 0 ? (
            <View className="bg-white rounded-2xl p-8 items-center shadow-sm">
              <Ionicons name="receipt-outline" size={64} color="#cbd5e1" />
              <Text className="text-gray-500 mt-4 text-center">
                {search ? 'No se encontraron tipos de egresos' : 'No hay tipos de egresos registrados'}
              </Text>
              {!search && (
                <Pressable
                  onPress={() => setIsOpen(true)}
                ...
                >
                    ...
                    <View className="flex-1">
                      ...
                      <View className="flex-row items-center gap-2 mt-2">
                        ...
                        <Text className="text-gray-600 text-sm">
                          Creado: {formatFecha(egreso.created_at)}
                        </Text>
                      </View>
                    </View>
                  </View>
                  ...
                  <View className="flex-row gap-2 mt-3 pt-3 border-t border-gray-100">
                    {onSelect ? (
                      ...
                      <>
                        <Pressable
                          onPress={() => handleAnular(egreso.idtipo_egreso, egreso.descripcion)}
                          className="flex-1 active:opacity-70"
                        >
